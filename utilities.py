...
def initialize_data():
    uopx_conv_rates = {'Streaming (Impressions)' : 0.007,'Digital (Clicks)' : 0.007,'Search (Clicks)' : 0.00719,'TV (Impressions)' : 0.000173}
    print('State initialized')
    excel = pd.read_excel("data_overview.xlsx",sheet_name=None)
